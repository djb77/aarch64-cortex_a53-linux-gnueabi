...
enum opt_code
{
  ...
  OPT_mabi_ = 1181,                          /* -mabi= */
  OPT_mandroid = 1182,                       /* -mandroid */
  OPT_march_ = 1183,                         /* -march= */
  OPT_mbig_endian = 1184,                    /* -mbig-endian */
  OPT_mbionic = 1185,                        /* -mbionic */
  OPT_mcmodel_ = 1186,                       /* -mcmodel= */
  OPT_mcpu_ = 1187,                          /* -mcpu= */
  OPT_mfix_cortex_a53_835769 = 1188,         /* -mfix-cortex-a53-835769 */
  OPT_mfix_cortex_a53_843419 = 1189,         /* -mfix-cortex-a53-843419 */
  OPT_mgeneral_regs_only = 1190,             /* -mgeneral-regs-only */
  OPT_mglibc = 1191,                         /* -mglibc */
  OPT_mlittle_endian = 1192,                 /* -mlittle-endian */
  OPT_mlow_precision_recip_sqrt = 1193,      /* -mlow-precision-recip-sqrt */
  OPT_mmusl = 1194,                          /* -mmusl */
  OPT_momit_leaf_frame_pointer = 1195,       /* -momit-leaf-frame-pointer */
  OPT_moverride_ = 1196,                     /* -moverride= */
  OPT_mpc_relative_literal_loads = 1197,     /* -mpc-relative-literal-loads */
  OPT_mstrict_align = 1198,                  /* -mstrict-align */
  OPT_mtls_dialect_ = 1199,                  /* -mtls-dialect= */
  OPT_mtls_size_ = 1200,                     /* -mtls-size= */
  OPT_mtune_ = 1201,                         /* -mtune= */
  OPT_muclibc = 1202,                        /* -muclibc */
  OPT_n = 1203,                              /* -n */
  ...
  OPT_static_libgcj = 1250,                  /* -static-libgcj */
  OPT_static_libgfortran = 1251,             /* -static-libgfortran */
  OPT_static_libgo = 1252,                   /* -static-libgo */
  OPT_static_liblsan = 1253,                 /* -static-liblsan */
  OPT_static_libmpx = 1254,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1255,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1256,               /* -static-libstdc++ */
  OPT_static_libtsan = 1257,                 /* -static-libtsan */
  OPT_static_libubsan = 1258,                /* -static-libubsan */
  /* OPT_std_c__03 = 1259, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1260, */                /* -std=c++0x */
  OPT_std_c__11 = 1261,                      /* -std=c++11 */
  OPT_std_c__14 = 1262,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1263, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1264, */                /* -std=c++1y */
  OPT_std_c__1z = 1265,                      /* -std=c++1z */
  OPT_std_c__98 = 1266,                      /* -std=c++98 */
  OPT_std_c11 = 1267,                        /* -std=c11 */
  /* OPT_std_c1x = 1268, */                  /* -std=c1x */
  /* OPT_std_c89 = 1269, */                  /* -std=c89 */
  OPT_std_c90 = 1270,                        /* -std=c90 */
  OPT_std_c99 = 1271,                        /* -std=c99 */
  /* OPT_std_c9x = 1272, */                  /* -std=c9x */
  OPT_std_f2003 = 1273,                      /* -std=f2003 */
  OPT_std_f2008 = 1274,                      /* -std=f2008 */
  OPT_std_f2008ts = 1275,                    /* -std=f2008ts */
  ...
  OPT_std_gnu__98 = 1285,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1286,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1287, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1288, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1289,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1290,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1291, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1292, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1293,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1294, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1295, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1296, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1297,                     /* -std=legacy */
  OPT_symbolic = 1298,                       /* -symbolic */
  OPT_t = 1299,                              /* -t */
  OPT_time = 1300,                           /* -time */
  OPT_time_ = 1301,                          /* -time= */
  OPT_tno_android_cc = 1302,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1303,                 /* -tno-android-ld */
